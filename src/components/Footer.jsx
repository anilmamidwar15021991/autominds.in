      ...
      <div className="container">
        <div className="row g-4 mb-5">
          <div className="col-lg-4 col-md-6">
            ...
            <p className="text-white small pe-lg-4 mb-4">
          ...
          <div className="col-lg-3 col-md-6">
            ...
            <p className="text-white small mb-3">Get weekly AI prompt hacks and course updates right in your inbox.</p>
        ...
        <div className="pt-4 border-top border-secondary d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
          ...
          <div className="d-flex gap-4 small text-white">
            ...
            <a href="#security" className="text-white text-decoration-none">Security</a>
          </div>
        </div>
      </div>
    </footer>
